<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="find-life-total-hepai.aspx.cs" Inherits="TestingReport.find_life_total_hepai" %>
        ...
        <div style="font-size:32px;">
            <table style="width:100%;text-align:center">
                <tr style="height:80px">
                    <td></td>
                    <td><span style="border-radius:10px;background-color:rgba(34,205,193,1);color:white;padding:20px;">幸福感</span></td>
                    <td><span style="border-radius:10px;background-color:skyblue;color:white;padding:20px;">工作满意度</span></td>
                    <td><span style="border-radius:10px;background-color:orangered;color:white;padding:20px;">生活状态</span></td>
                </tr>
                <tr style="height:80px">
                ...
                <tr style="height:80px">
                    <td style="padding-top:20px;padding-bottom:20px;">
                        <img src="img/2-right.png" style="width:160px;border-radius:80px;border-radius:80px;" /><br />
                        Jeffrey</td>
                    <td></td>
                    <td>50%</td>
                    <td>40%</td>
