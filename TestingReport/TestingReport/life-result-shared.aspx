...
<body style="background-color:white">
  ...
  <div style="background-color:rgba(34,205,193,1);height:150px;position:relative;">
    ...
    <div style="text-align:center;font-size:36px;padding-left:50px;padding-right:50px;margin:0px 60px;">
       ...
       <div style="width:60%;margin:60px auto 100px auto;border-radius:10px;border:none;text-align:center !important;font-size:36px !important;height:100px;background-color:rgba(34,205,193,1);cursor:pointer;line-height:100px;color:white"><a href="middle.aspx?id=3&shareid=<%=Request["shareduserid"] %>" style="color:white" >我也要测</a></div>
