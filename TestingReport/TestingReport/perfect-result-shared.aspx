<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="perfect-result-shared.aspx.cs" Inherits="TestingReport.perfect_result_shared" %>
...
<body style="background-color:white">
   ...
   <div style="text-align:center;color:white;padding-top:120px;padding-bottom:30px;background-color:rgba(34,205,193,1)">
        ...
        <div style="padding:20px 40px;margin-left:80px;margin-right:80px;text-align:center;font-size:50px;font-weight:bold;margin-top:10px;"><span>完美主义测试报告</span>
           </div>
    ...
    <div style="margin-top:30px">
      ...
      <div style="width:60%;margin:30px auto 100px auto;border-radius:10px;border:none;text-align:center !important;font-size:36px !important;height:100px;background-color:rgba(34,205,193,1);cursor:pointer;line-height:100px;color:white"><a href="middle.aspx?id=10" style="color:white" >我也要测</a></div>
    ...
    var option1 = {
        ...
        series: [
            {              
                ...
                data: [<%=perfect_1%>,<%=perfect_2%>,<%=perfect_3%>],
