<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="world-result.aspx.cs" Inherits="TestingReport.world_result" %>
...
<body style="background-color:white">
    ...
    <div style="padding:80px">
            ...
            <div style="float:right;font-size:40px;color:grey;"><a href="learn-self-world-hepai.aspx?userid=<%=Request["userid"] %>" style="color:grey">查看更多..</a></div>
                </div>
