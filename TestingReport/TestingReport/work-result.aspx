<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work-result.aspx.cs" Inherits="TestingReport.work_result" %>
...
<body style="background-color:white">
    ...
    <div>
        <div style="width:500px;color:white;background-color:#1d3d4c;opacity:0.6;text-align:center;margin:40px auto;padding-top:10px;padding-bottom:10px;">工作满意度测试
    ...
    <div style="padding:80px">
            ...
            <div style="float:right;font-size:40px;color:grey;"><a href="find-life-work-hepai.aspx?userid=<%=Request["userid"] %>" style="color:grey">查看更多..</a></div>
                </div>
               ...
               <div style="color:rgba(34,205,193,1);margin-bottom:50px;">为了保持测试结果的客观性，建议不要连续重复测试</div>
                <div style="overflow:hidden">
                    ...
                    <div style="width:40%;float:right;border-radius:10px;border:none;text-align:center !important;font-size:30px !important;height:100px;background-color:rgba(34,205,193,1);cursor:pointer;line-height:100px;color:white">
                        <a href="vote.aspx?id=5&userid=<%=Request["userid"] %>" style="color:white">继续测试</a>
