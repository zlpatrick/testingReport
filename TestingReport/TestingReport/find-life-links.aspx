<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="find-life-links.aspx.cs" Inherits="TestingReport.find_life_links" %>
...
<body style="background-color:white">
    ...
    <div style="text-align:center;color:white;padding-top:30px;padding-bottom:30px;background-color:rgba(34,205,193,1)">
        <div>幸福宝典</div>
        <div class="user-tag">
            <span><a href="knowledge.aspx?userid=<%=Request["userid"] %>" style="color:white">所有文章</a></span><span>认识自我</span><span  class="user-tag-active">发现生活</span>
        </div>
