<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="happy-feeling-result-shared.aspx.cs" Inherits="TestingReport.happy_feeling_result_shared" %>
...
<body style="background-color:white">
    ...
    <div style="text-align:center;color:white;padding-top:120px;padding-bottom:30px;background-color:rgba(34,205,193,1)">
        ...
        <div style="padding:20px 40px;margin-left:80px;margin-right:80px;text-align:center;font-size:50px;font-weight:bold;margin-top:10px;"><span>2016,你幸福吗?</span>
           </div>
    ...
    <div>
        <div style="width:500px;color:white;background-color:rgba(34,205,193,1);text-align:center;margin:40px auto;padding-top:10px;padding-bottom:10px;">幸福感测试
    ...
    <div style="text-align:center;font-size:36px;padding-left:50px;padding-right:50px;margin:0px 60px;">
        ...
        <div style="margin-top:30px;margin-left:80px;margin-right:80px;background-color:rgba(252,251,252,1)">
           ...
           <div style="width:60%;margin:30px auto 100px auto;border-radius:10px;border:none;text-align:center !important;font-size:36px !important;height:100px;background-color:rgba(34,205,193,1);cursor:pointer;line-height:100px;color:white"><a href="middle.aspx?id=2" style="color:white" >我也要测</a></div>
        ...
        series: [
            {
                ...
                data: [{ value: <%=totalChartValue%>, name: '幸福感', }],
    ...
    var option1 = {
        ...
        series: [
            {              
                ...
                data: [<%=happy_1%>,<%=happy_2%>,<%=happy_3%>,<%=happy_4%>],
