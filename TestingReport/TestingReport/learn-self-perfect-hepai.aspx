<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="learn-self-perfect-hepai.aspx.cs" Inherits="TestingReport.learn_self_perfect_hepai" %>
...
<body style="background-color:white">
    ...
    <div style="text-align:center;color:white;padding-top:120px;padding-bottom:30px;background-color:rgba(34,205,193,1)">
        ...
        <div>
        <div style="width:500px;color:white;background-color:#1d3d4c;opacity:0.6;text-align:center;margin:40px auto;padding-top:10px;padding-bottom:10px;">完美主义测试
