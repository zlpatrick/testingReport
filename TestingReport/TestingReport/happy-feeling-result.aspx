...
<body style="background-color:white">
        ...
        <div style="overflow:hidden;margin-top:80px;margin-bottom:40px;margin-left:80px;margin-right:80px;">
            <div style="padding-left:30px;border-left:8px solid rgba(34,205,193,1);float:left;color:rgba(34,205,193,1);margin-bottom:30px">维度分析</div>
              <div style="text-align:center;clear:both">
                      <span style="color:rgba(34,205,193,1);font-size:40px;text-align:center">幸福感由以下因素组成</span>
                      <hr />
   ...
   <div style="width:60%;margin:30px auto 200px auto;border-radius:10px;border:none;text-align:center !important;font-size:36px !important;height:100px;background-color:rgba(34,205,193,1);cursor:pointer;line-height:100px;color:white"><a href="#" style="color:white" data-toggle="modal" data-target="#confirmationDialog">觉得结果不准确？再测一次</a></div>
        <%}else {%>
  <div style="width:60%;margin:30px auto 200px auto;border-radius:10px;border:none;text-align:center !important;font-size:36px !important;height:100px;background-color:rgba(34,205,193,1);cursor:pointer;line-height:100px;color:white"><a href="vote.aspx?id=2" style="color:white" >我也要测</a></div>
