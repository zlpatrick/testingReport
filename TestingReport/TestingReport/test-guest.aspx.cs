...
{
    public partial class test_guest : System.Web.UI.Page
    {
        ...
        protected void startTest(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Response.Redirect("world-result-guest.aspx?id=" + Request["id"].ToString() + "&userid=" + userid + "&type=" + Request["type"].ToString() + "&token=" + Request["token"]);
                }
                else if ("10".Equals(Request["id"].ToString()))
                {
                    Response.Redirect("perfect-result-guest.aspx?id=" + Request["id"].ToString() + "&userid=" + userid + "&type=" + Request["type"].ToString() + "&token=" + Request["token"]);
                }
                else if ("2".Equals(Request["id"].ToString()))
                {
                    Response.Redirect("happy-feeling-result-guest.aspx?id=" + Request["id"].ToString() + "&userid=" + userid + "&type=" + Request["type"].ToString()+"&token="+Request["token"]);

                }
                else if ("5".Equals(Request["id"].ToString()))
                {
                    Response.Redirect("work-result-guest.aspx?id=" + Request["id"].ToString() + "&userid=" + userid + "&type=" + Request["type"].ToString() + "&token=" + Request["token"]);

                }
                else if ("3".Equals(Request["id"].ToString()))
                {
                    Response.Redirect("life-result-guest.aspx?id=" + Request["id"].ToString() + "&userid=" + userid + "&type=" + Request["type"].ToString() + "&token=" + Request["token"]);

                }
                else if ("11".Equals(Request["id"].ToString()))
                {
                    Response.Redirect("health-result-guest.aspx?id=" + Request["id"].ToString() + "&userid=" + userid + "&type=" + Request["type"].ToString() + "&token=" + Request["token"]);
